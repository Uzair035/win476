                    ...
                    <div class="account-wrapper">
                        <form class="account-form verify-gcaptcha" method="POST" action="{{ route('user.login') }}">
                            ...
                            <div class="account-thumb-area text-center">
                                <h3 class="title">@lang('Welcome Back to') </h3>
                                 <a class="site-logo site-title" href="{{ route('home') }}"><img src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" width="150px" alt="image"></a>
                            </div>
