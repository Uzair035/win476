                    ...
                    <div class="account-wrapper">
                        <form class="account-form verify-gcaptcha" method="POST" action="<?php echo e(route('user.login')); ?>">
                            ...
                            <div class="account-thumb-area text-center">
                                <h3 class="title"><?php echo app('translator')->get('Welcome Back to'); ?> </h3>
                                 <a class="site-logo site-title" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(getImage(getFilePath('logoIcon') . '/logo.png')); ?>" width="150px" alt="image"></a>
                            </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ignwamlz/win476.com/core/resources/views/templates/basic/user/auth/login.blade.php ENDPATH**/ ?>